...
if(isset($_POST["listele"])) 
{
    ...
    $sorgu->execute([          
        ...
        $sqlsay = "SELECT COUNT(id) FROM book WHERE categoyId = ?";
        $sorgusay = $baglan->prepare($sqlsay);
        $sorgusay->execute([$_POST["categoyId"]]);
        ...
        $sqlsay = "SELECT COUNT(id) FROM book WHERE authorId = ?";
        $sorgusay = $baglan->prepare($sqlsay);
        $sorgusay->execute([$_POST["authorId"] ]);
        $say = $sorgusay->fetch(PDO::FETCH_ASSOC);
        ...
        $sqlsay = "SELECT COUNT(id) FROM book WHERE authorId = ? AND categoyId = ?";
        $sorgusay = $baglan->prepare($sqlsay);
        $sorgusay->execute([ $_POST["authorId"],
        $_POST["categoyId"]]);
        $say = $sorgusay->fetch(PDO::FETCH_ASSOC);
