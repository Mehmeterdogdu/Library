...
<body>
    ...
    <header>
        <div class="container">
            <div class="row">
                <h1 class="display-1 text-center">Öğrenci Detay Ekranı</h1>
            </div>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">Email: <?=$satir["email"]?></h6>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum minima officiis quidem.</p>
                            <p class="card-text">Password: <?=$satir["password"]?></p>
                            <p class="card-text">Telefon: <?=$satir["mobileNumber"]?></p>
                            <p class="card-text">Tarih: <?=$satir["createDate"]?></p>

                            
                            <a href="#" class="card-link">Github Hesabı</a>
                            <a href="#" class="card-link">Linkedin Hesabı</a>
                        </div>
                    </div>
                </div>
            </div>
